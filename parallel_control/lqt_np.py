"""
Numpy-based Linear Quadratic Regulator and Tracker routines, both sequential and parallel
...
class LQR:
    ...
    def parBackwardPass_init(self,T):
        """ Initialize the parallel backward pass of length T. Returns
    ...
    def parBackwardPass_extract(self,elems):
        """ Extract the results of backward pass from element list. Returns
            the list of control gains for 0:T-1 and list of matrices
            such that V(x_k) = 1/2 x_T.T S x_k for k=0:T """
        (A,b,C,eta,J) = elems[0]
        S_list = [J]
        Kx_list = []
    ...
    def parBackwardPass(self,T):
        """ Perform the whole parallel backward pass of length T. Returns
            the list of control gains for 0:T-1 and list of matrices
            such that V(x_k) = 1/2 x_T.T S_k x_k for k=0:T """
...
class LQT:
    ...
    @classmethod
    def checkAndExpand(cls,F,L,X,U,XT=None,c=None,H=None,r=None,HT=None,rT=None,Z=None,s=None,M=None,T=None):
        """
