...
def write_to_file(name,methods,steps,run_times,errors,config):
    devtxt = ''
    ...
    order = config["order"]
    filename = 'res/%s_%d_%d_%s.txt' % (name,order,steps,devtxt)
...
def main(argv):
    ...
    write_to_file('text_steps', methods, steps, run_times, err_list, config)
